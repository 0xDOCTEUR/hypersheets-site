(function () {
  ...
  var I18N = {
    fr: {
      ...
      footCollect: "1 wallet · 2 collect · 3 sync",
      ...
      emptyStepsBody: "1. Collecte -> ajoute un wallet HL<br/>2. Collecter Omni<br/>3. Synchroniser -> Points sur Hypersheets",
      pnlTotal: "PNL TOTAL",
      open: "Ouvrir",
      collapse: "Replier",
      rename: "Renommer",
    ...
    en: {
      ...
      emptyStepsBody: "1. Collect -> add an HL wallet<br/>2. Collect Omni<br/>3. Sync -> Points on Hypersheets",
      pnlTotal: "TOTAL PNL",
      open: "Open",
      collapse: "Collapse",
      rename: "Rename",
